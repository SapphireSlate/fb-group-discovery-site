...
export default function RegisterPage() {
  ...
  const handleSignUpWithGoogle = async () => {
    ...
    try {
      ...
      // Use a safe way to get origin that works on both server and client
      let redirectUrl;
      if (typeof window !== 'undefined') {
        redirectUrl = `${window.location.origin}/auth/callback`;
      } else {
        // Fallback if NEXT_PUBLIC_SITE_URL is not defined
    ...
    <div className="container mx-auto max-w-md py-12">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sign up to discover and share Facebook groups
          </CardDescription>
        </CardHeader>
        <CardContent>
